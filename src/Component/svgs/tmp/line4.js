...
register(SVGS, {
  ...
  payload: function(cmpConfig) {
    ...
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49.86 17" style="width: ${cmpConfig.layoutConfig.width}; height: ${cmpConfig.layoutConfig.height};color:${cmpConfig.props.color}">
    <title>未标题-2</title>
