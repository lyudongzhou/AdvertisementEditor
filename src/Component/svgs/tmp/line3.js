...
register(SVGS, {
  ...
  payload: function(cmpConfig) {
    ...
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 46.04" style="width: ${cmpConfig.layoutConfig.width}px; height: ${cmpConfig.layoutConfig.height}px;color:${cmpConfig.props.color}">
    <title>未标题-2</title>
